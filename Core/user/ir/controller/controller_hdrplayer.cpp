/**	\file	controller_hdrplayer.cpp
 * 	\brief	硬碟播放器遙控器 IR code 定義
 *
...
#define	HDR_PLAYER	0xff00	///< 硬碟播放器遙控器的 custom code
 ...
 *
 */
const IR_CODE hdrplayer_codeTable[] =	///< 硬碟播放器遙控器 IR code table
{
